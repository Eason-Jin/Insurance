...
public class MainTest {
  ...
  public static class YourTests extends CliTest {
    ...
    @Test
    public void TY_01_delete_not_loaded_profile() throws Exception {
      // Write your own test here, in the same format as the other tests.
      runCommands(
          unpack(CREATE_SOME_CLIENTS, LOAD_PROFILE, "Tom", DELETE_PROFILE, "Jenny", PRINT_DB));
      ...
      assertDoesNotContain("Jenny, 23", true);
    }

    @Test
    public void TY_02_two_policies_each_for_two_profiles() throws Exception {
      // Write your own test here, in the same format as the other tests.
      runCommands(
          unpack(
              CREATE_SOME_CLIENTS,
      ...
      assertContains("2: Tom, 25, 2 policies for a total of $27000");
      assertContains(
          "Home Policy (20 Symonds Street, Sum Insured: $1000000, Premium: $20000 -> $18000)");
      assertContains(
          "Home Policy (20 Queen Street, Sum Insured: $1000000, Premium: $10000 -> $9000)");
      assertContains("*** 3: Jenny, 23, 2 policies for a total of $18495");
    ...
    @Test
    public void T2_M01_load_invalid_profile_while_already_loaded_2() throws Exception {
      runCommands(
    ...
    @Test
    public void T2_M02_create_profile_when_profile_loaded_2() throws Exception {
      runCommands(
    ...
    @Test
    public void T2_M03_create_profile_after_profile_loaded_2() throws Exception {
      runCommands(
          unpack(
              CREATE_SOME_CLIENTS,
              LOAD_PROFILE,
    ...
    @Test
    public void T2_M04_delete_profile_not_found_2() throws Exception {
    ...
    @Test
    public void T3_M01_create_car_policy_age_test_2() throws Exception {
      runCommands(
          unpack( //
              CREATE_SOME_CLIENTS, //
              LOAD_PROFILE,
    ...
    @Test
    public void T3_M02_maximum_age_boundary_life_policy_2() throws Exception {
      runCommands( //
          CREATE_PROFILE,
          "cAMEROn",
          "100", //
    ...
    @Test
    public void T3_M03_only_one_life_policy_per_profile_2() throws Exception {
      runCommands(
          unpack(
              CREATE_SOME_CLIENTS, //
              LOAD_PROFILE,
